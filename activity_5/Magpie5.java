...
public class Magpie5
{
	...
	private String transformIWantSomething(String statement)
	{
		...
		int psn = findKeyword (statement, "I want something", 0);
		String restOfStatement = statement.substring(psn + 9).trim();
	...
	private String transformLikeStatement(String statement)
	{
		...
		int psnOfLike = findKeyword (statement, "I", 0);
		int psnOfLove = findKeyword (statement, "you", psnOfLike + 3);
		
		String restOfStatement = statement.substring(psnOfLike + 3,psnOfLove ).trim();
